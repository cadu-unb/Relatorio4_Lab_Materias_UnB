...
\begin{figure*}[h]
\centering
\includegraphics[width=0.8\linewidth]{imagens/PNG/reduced_exp4_curvaID.png}
...
\fbox{\begin{minipage}{0.9\linewidth}
    \centering
%\vspace{2cm}
\includegraphics[width=0.95\textwidth]{fotos/reduced_IMG_0630.jpeg}
%\centering\textit{Foto do Circuito 2.}
%\vspace{2cm}
\end{minipage}}
\caption{Forma de onda do Circuito 1 (medição da defasagem).}
\label{fig:circ1_delay}
\end{figure}

\textbf{Atraso de condução medido:}
\begin{equation}
t_{\mathrm{delay,1}} = 116~\mathrm{us}
\end{equation}
...
\fbox{\begin{minipage}{0.9\linewidth}
    \centering
%\vspace{2cm}
\includegraphics[width=0.95\textwidth]{fotos/reduced_IMG_0633.jpeg}
%\centering\textit{Foto do Circuito 2.}
%\vspace{2cm}
\end{minipage}}
\caption{Forma de onda do Circuito 2 (medição da defasagem).}
\label{fig:circ2_delay}
\end{figure}

\begin{equation}
t_{\mathrm{delay,2}} = 240~\mathrm{us}
\end{equation}
...
\fbox{\begin{minipage}{0.9\linewidth}
    \centering
%\vspace{2cm}
\includegraphics[width=0.95\textwidth]{fotos/reduced_IMG_0636.jpeg}
%\centering\textit{Foto do Circuito 2.}
%\vspace{2cm}
\end{minipage}}
\caption{Forma de onda do Circuito 4 (medição da defasagem).}
\label{fig:circ4_delay}
\end{figure}

\begin{equation}
t_{\mathrm{delay,4}} = 148~\mathrm{us}
\end{equation}

Observação: a defasagem foi medida do ponto de cruzamento da onda de entrada até o início da condução na saída. Para contabilizar o tempo total sem condução, deve-se considerar também o intervalo sem condução do semiciclo negativo anterior, ou seja, espera-se algo em torno de $120\cdot 2~\mathrm{us} = 240~\mathrm{us}$ (o dobro do atraso obtido no circuito 1, com apenas um diodo em série)
...
\fbox{\begin{minipage}{0.9\linewidth}
    \centering
%\vspace{2cm}
\includegraphics[width=0.95\textwidth]{fotos/reduced_IMG_0641.jpeg}
%\centering\textit{Foto do Circuito 2.}
%\vspace{2cm}
\end{minipage}}
\caption{Forma de onda do Circuito 5 (medição da defasagem).}
\label{fig:circ5_delay}
\end{figure}

\begin{equation}
t_{\mathrm{delay,5}} = 520~\mathrm{\mu s}
\end{equation}
...
\begin{table}[!t]
    ...
    \begin{tabular}{@{}ccc@{}}
        \hline
        \rule{0pt}{2.6ex}\textbf{Circuito} & \textbf{Defasagem} [\(\mu\)s] & \textbf{Atenuação} [V] \\[3pt]
        \hline
        \rule{0pt}{2.4ex}1 & 116 & 0.720 \\
        2 & 240 & 1.32 \\
        3 & $\infty^{[1]}$ & $\approx 4.0^{[2]}$ \\
        4 & $148^{[3]}$ & 0.720 \\
        5 & 520 & 0.720 \\[2pt]
        \hline
        \multicolumn{3}{@{}p{0.95\columnwidth}@{}}{\footnotesize
            $^{[1]}$ Atraso infinito, pois o diodo não conduz.
        }\\[2pt]
        \multicolumn{3}{@{}p{0.95\columnwidth}@{}}{\footnotesize
            $^{[2]}$ Valor aproximado equivalente à totalidade da tensão de pico $V_p$, pois o diodo não conduz (atenuação total).
        }\\[2pt]
        \multicolumn{3}{@{}p{0.95\columnwidth}@{}}{\footnotesize
            $^{[3]}$ Atraso entre tensão nula e início da condução no semiciclo positivo. Considerar o dobro do valor para o atraso total, incluindo semiciclo negativo.
        }\\
        \hline
    \end{tabular}
    \vspace{-3mm}
