...
\author{Carlos Eduardo da Silva Papa\\
...
%%%%%%%%%%%% MATERIAIS %%%%%%%%%%%%%
\input{r4-materiais.tex} %%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%% PROCEDIMENTOS %%%%%%%%%%%%
\input{r4-procedimentos.tex} %%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%% RESULTADOS E ANÁLISE DOS RESULTADOS %%%%%%%%%%%
\input{r4-resultados.tex}  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%% CONCLUSÕES %%%%%%%%%%%%%%
\input{r4-conclusoes.tex} %%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
